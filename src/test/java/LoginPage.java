...
public class LoginPage extends RunCucumberTests {
    ...
    public void verifyLogin() {
        ...
        String homePageHeading = driver.findElement(By.xpath("//*[@id='app']/div[1]/div[1]/header/div[1]/div[1]/span/h6")).getText();
